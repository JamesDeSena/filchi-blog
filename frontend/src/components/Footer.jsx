  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: "linear-gradient(to bottom,#012b5d, #0a1729)",
      }}
    >
      <br />
      <br />
      <div className="row" style={{ marginRight: "10px" }}>
        <div className="col-lg-5 col-md-6" style={{ marginTop: "20px" }}>
          <span>
            <a
              className="botlogo  d-flex align-items-center text-center"
              href="index.html"
            >
        ...
        <div
          ...
          style={{ color: "#ffffff", marginLeft: "2%", marginTop: "20px" }}
        >
          <h5
            className="mb-4"
            style={{
          ...
          <a
            ...
            style={{ color: "#ffffff" }}
            href="https://www.filchi-jobfair.com/index.html"
          >
            Home
          </a>
          <a
            className="btn btn-link"
            style={{ color: "#ffffff" }}
            href="https://www.filchi-jobfair.com/exhibit.html"
          >
            Exhibit Now
          </a>
          <a
            className="btn btn-link"
            style={{ color: "#ffffff" }}
            href="https://www.filchi-jobfair.com/visit.html"
          >
            Visit Us
          </a>
          <a
            className="btn btn-link"
            style={{ color: "#ffffff" }}
            href="https://www.filchi-jobfair.com/gallery.html"
          >
            Gallery
          </a>
          <a
            className="btn btn-link"
            style={{ color: "#ffffff" }}
            href="https://www.filchi-jobfair.com/contact.html"
          >
            Contact Us
          </a>
          <a
            ...
            style={{ color: "#ffffff" }}
            target="_blank"
            href="https://filchi-jobfair-blog.netlify.app/"
          >
            Blog
          </a>
        </div>
        <div
          className="col-lg-3 col-md-6"
          style={{ marginLeft: "2%", marginTop: "20px" }}
        >
          <h5
            className="mb-4"
            style={{
          ...
          <a
            href="https://goo.gl/maps/VHg1t4Kerzx7NYrx9"
          ...
          <a href="tel:+639666376696" style={{ textDecoration: "none" }}>
            <p className="mb-2" style={{ color: "#ffffff" }}>
              <i className="fa fa-phone me-3" style={{ color: "#ffffff" }}></i>
              +63 966 637 6696
            </p>
          </a>
          <a
            href="mailto:filchijobfair@flw.ph"
            style={{ textDecoration: "none" }}
          >
            <p className="mb-2" style={{ color: "#ffffff" }}>
              <i
          ...
          <div className="d-flex pt-2">
            <a
              ...
              style={{ color: "#ffffff" }}
              href="https://www.facebook.com/filchijobfair?mibextid=ZbWKwL"
            >
            ...
            <a
              className="btn btn-outline-light btn-social"
              style={{ color: "#ffffff" }}
              href="https://www.youtube.com/playlist?list=PLIKNmEeC3y6So3zvSMO5aRM_AZunmYuP_"
            >
            ...
            <a
              className="btn btn-outline-light btn-social"
              style={{ color: "#ffffff" }}
              href="https://www.linkedin.com/company/filchijobfair/"
            >
            ...
            <a
              className="btn btn-outline-light btn-social"
              style={{ color: "#ffffff" }}
              href="https://www.instagram.com/filchijobfair/"
            >
